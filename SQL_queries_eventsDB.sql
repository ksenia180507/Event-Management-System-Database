...
-- Display the session titles with speakers and their fields of expertise
SELECT SE.session_title AS Session, CONCAT(U.first_name, ' ', U.last_name) AS Speaker, SP.field_expertise AS Expertise
...
INSERT INTO Registrations (purchase_date, participant_id, event_id) 
VALUES (CURDATE(), 3, 2);
